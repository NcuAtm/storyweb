...
class Update(TelegramObject):
    def __init__(self, update_id=None, message=None, callback_query=None, channel_post=None, *args, **kwargs):
...
class Message(TelegramObject):
    ...
    forward_from_chat=None, reply_to_message=None, text=None, forward_from_message_id=None, forward_date=None, photo=None, *args, **kwargs):
...
#class channel_post(TelegramObject):
#    def __init__(self, chat_id=None, photo=None, caption=None, *args, **kwargs):
